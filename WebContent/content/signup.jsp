					...
					<div class="col-lg-6">
						<form id="myForm" method="post" class="bs-example form-horizontal"
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="AddressInput" class="col-lg-3 control-label">
										Address</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" name="address"
											id="AddressInput" placeholder="Addess" />
									</div>
								</div>
								

								<div class="form-group">
									<label for="uploadPhotoInput" class="col-lg-3 control-label">Upload
										Photo</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" name="uploadPhoto"
											id="uploadPhotoInput" placeholder="Upload Photo" />
									</div>
								</div>
